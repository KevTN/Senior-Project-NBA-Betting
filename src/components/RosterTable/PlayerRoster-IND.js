...
const title = 'Indiana Pacers Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const pacersIDs = [38017701, 3547245, 17896035, 44477085, 242, 38017686, 304, 305, 38017507, 3547250, 56677861, 416, 3547264, 3547243, 56677778, 452, 56677832, 56677794];
        const responses = await Promise.all(pacersIDs.map(id =>
