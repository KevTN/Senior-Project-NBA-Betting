...
const title = 'Dallas Mavericks Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const hawkIDs = [17896028, 132, 151, 56677867, 666577, 3547258, 191, 38017679, 228, 247, 257, 17554004, 56677840, 329, 379, 56677859, 666950, 24489167];
