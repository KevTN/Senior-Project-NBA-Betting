...
const title = 'Boston Celtics Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const celticsIDs = [666468, 70, 38017707, 17896060, 214, 219, 261,338, 64270311, 378, 3547276, 17553967, 17896025, 434, 3547285, 56677864, 473];
        const responses = await Promise.all(celticsIDs.map(id =>
