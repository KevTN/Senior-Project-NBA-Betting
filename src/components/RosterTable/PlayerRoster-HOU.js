...
const title = 'Houston Rockets Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const rocketsIDs = [3, 66, 75, 38017695, 17895966, 188, 3547281, 213, 19465326, 296, 56677809, 17896062, 38017684, 3547301, 56677825, 458, 56677831, 47738533];
        const responses = await Promise.all(rocketsIDs.map(id =>
