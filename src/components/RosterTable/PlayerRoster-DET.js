...
const title = 'Detroit Pistons Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const pistonsIDs = [38017718, 68, 17896075, 38017694, 64268165, 3547275, 38017739, 160, 173, 17895858, 38017682, 42097199, 56677792, 3547267, 56677826, 44477024, 3547240];
        const responses = await Promise.all(pistonsIDs.map(id =>
