...
const title = 'LA Clippers Roster';
...
export default function CustomizedTables() {
  ...
  useEffect(() => {
    const fetchRosterData = async () => {
      try {
        const clipsIDs = [17896022, 56677849, 666511, 38017725, 172, 192, 17896031, 274, 666743, 56677856, 24417679, 371, 380, 17896051, 439, 450, 472, 493];
        const responses = await Promise.all(clipsIDs.map(id =>
